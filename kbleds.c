...
MODULE_DESCRIPTION("Example module illustrating the use of Keyborad LEDs.");
...
/*
 * Function my_timer_func blinks the keyborad LEDs periodically by invoking
 * command KDSETLED of ioctl() on keyborad driver. To learn more on virtual.
 * terminal ioctl operations, please see file drivers/tty/vt/vt_ioctl.c function
 * vt_ioctl().
 *
